...
//     return (
//         <div className="isolate bg-purple-50 px-6 sm:pb-32 lg:px-8">
...
//                     <p className="mt-5 text-lg leading-8 text-gray-200 font-white font-lato">
//                         Fill out this form <br /> Call us on <span className="text-amber-300 text-xl font-bodoni-moda-bold">0834143211</span>  <br /> Or email us via <span className='text-amber-300 text-xl font-bodoni-moda-bold'>silvana@silvanajewellery.com</span>
//                     </p>
//                 </div>
